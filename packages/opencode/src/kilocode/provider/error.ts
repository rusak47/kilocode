...
const RETRYABLE_TEXT = /rate increased too quickly|rate.?limit|too.?many.?requests|try again (?:later|in\b)|(?:currently|temporarily) at capacity|limit reached|internal server error|internal error|resourceexhausted|overloaded|temporarily unavailable/i
